package com.empresa.rhrich.persistence.jpa.departamento;
...
@PlcQueryService
public class DepartamentoDAO extends PlcBaseJpaDAO  {

	@PlcQuery("querySel")
	public native List<DepartamentoEntity> findList(
