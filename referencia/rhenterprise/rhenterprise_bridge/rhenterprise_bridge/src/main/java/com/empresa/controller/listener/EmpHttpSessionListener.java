...
/**
 * Bridge. Classe que implementa o DP "Listener" para Sesṣo
 */
abstract public class EmpHttpSessionListener extends PlcHttpSessionListener {
	/**
	 * vitoria: Realiza procedimentos no momento de encerramento de cada Sesṣo
	 */
	@Override
	...
	/**
	 * vitoria: Realiza procedimentos no momento de inicializa̤̣o de cada Sesṣo
	 */
	@Override
	public void aoInicializarSessao(HttpSessionEvent event, PlcCacheSessionVO plcSessao) {
		...
		// Coloca Javascript complementar da aplica̤̣o
