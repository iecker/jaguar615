...
@PlcConfigApplication(
	...
	classesDiscreteDomain={com.acme.planos_assist.dominio.TipoPlanos.class},
	classesLookup={},

	definition = @PlcConfigApplicationDefinition(name = "", release = 0, acronym = "", version = 0)
	
)     

package com.powerlogic.jcompany.config.pla;
