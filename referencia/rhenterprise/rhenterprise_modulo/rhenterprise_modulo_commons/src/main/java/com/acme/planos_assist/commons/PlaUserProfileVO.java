 ...
 */ 
package com.acme.planos_assist.commons;

import com.powerlogic.jcompany.commons.PlcBaseUserProfileVO;

/**
* modulo_planos_assistenciais. Implementar aqui atributos de personalizaÃ§Ã£o
* especÃ­ficos do usuario.
*/
public class PlaUserProfileVO extends PlcBaseUserProfileVO {
