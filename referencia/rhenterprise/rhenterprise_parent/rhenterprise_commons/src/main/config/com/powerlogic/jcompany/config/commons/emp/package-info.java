 ...
 */ 
  ...
  *******************************************************************************************/
@PlcConfigCompany(name = "Acme", domain = "www.acme.com.br", acronym = "ACME", 
			logo = "/res/midia/marca_empresa.gif", address = "Rua X, 12",
			supportEmail = "suporte@acme.com.br",supportPhone = "55 11 5000-5000")
			
@PlcConfigSuffixClass (entity="Entity",repository="Repository")

@PlcConfigPackage (entity=".entity.", application="com.acme.rhdemoenterprise")
