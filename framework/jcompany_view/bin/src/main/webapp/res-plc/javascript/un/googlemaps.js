...
jQuery(function(){
	...
	if (mapa) {
		...
		html += '<iframe name="googleMaps" id="googleMaps" src="'+ plcGeral.contextPath +'/res-plc/javascript/un/googlemaps.html" width="'+ width +'" height="'+ height +'" style="display: none"></iframe>';
