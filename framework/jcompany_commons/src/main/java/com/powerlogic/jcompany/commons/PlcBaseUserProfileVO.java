 ...
 * 
 */
// TODO - Refatorar PlcBaseUsuarioPerfilVO de forma a manter dados de usuário no jSecurity (caso use).
// Colocar os dados do jSecurity em outro objeto ou como componente deste.
@QPlcDefault
@SessionScoped
public class PlcBaseUserProfileVO implements Serializable {
