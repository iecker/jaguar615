...
public class PlcSelectPreference extends CoreSelectBooleanRadio {
	...
	static public final String			COMPONENT_TYPE		= "com.powerlogic.jsf.componente.PlcSelectPreferencia";

	static public final FacesBean.Type	TYPE				= new FacesBean.Type(CoreSelectBooleanRadio.TYPE);

	static public final PropertyKey		PLC_PREFERENCIA		= TYPE.registerKey("plcPreferencia", String.class);
	...
	static {
		...
		TYPE.lockAndRegister(COMPONENT_TYPE, PlcSelectPreferenceRenderer.RENDERER_TYPE);
	}
