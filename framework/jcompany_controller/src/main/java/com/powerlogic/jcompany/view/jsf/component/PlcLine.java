...
/**
 * Especialização do componente base HtmlRowLayout para permitir IoC e DI nos componentes JSF/Trinidad. 
 * 
 */
public class PlcLine extends HtmlRowLayout {
	...
	static public final String			COMPONENT_TYPE		= "com.powerlogic.jsf.componente.PlcLinha";

	static public final FacesBean.Type	TYPE				= new FacesBean.Type(HtmlRowLayout.TYPE);
