 ...
 * 
 */
public class PlcPanelFormLayout extends CorePanelFormLayout {
	...
	static public final String			COMPONENT_TYPE		= "com.powerlogic.jsf.componente.PlcPanelFormLayout";

	static public final FacesBean.Type	TYPE				= new FacesBean.Type(CorePanelFormLayout.TYPE);

	static public final PropertyKey		AOSAIR_KEY			= TYPE.registerKey("aoSair", String.class);
	...
	static {
		...
		TYPE.lockAndRegister(COMPONENT_TYPE, PlcPanelFormLayoutRenderer.RENDERER_TYPE);
	}
