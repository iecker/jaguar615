...
public class ViewScopedContext implements Context, SystemEventListener {
	...
	/**
	 * Testa se o JSF está registrado para que o evento {@link PreDestroyViewMapEvent} 
	 * possa limpar o contexto 
	 */
	...
	private void assertActive() {
		if (!isActive()) {
			throw new ContextNotActiveException(
					"Context with scope annotation @ViewScoped is not active with respect to the current thread");
		}
	}
	...
	private Map<Contextual<?>, Object> getComponentInstanceMap() {
		...
		Map<Contextual<?>, Object> map = (Map<Contextual<?>, Object>) viewMap
