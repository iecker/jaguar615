...
public class ServletContextMock implements ServletContext
{
    ...
    private RequestDispatcherMock dispatcher = null;
    private static Log logger = LogFactory.getLog( ServletContextMock.class );
    ...
    {
        dispatcher =  new RequestDispatcherMock(urlpath);
        return dispatcher;
    }
     ...
     */
    public RequestDispatcherMock getRequestDispatcherSimulator() {
        return dispatcher;
    }
