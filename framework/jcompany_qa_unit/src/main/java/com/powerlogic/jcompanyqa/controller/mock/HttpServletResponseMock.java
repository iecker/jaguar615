...
public class HttpServletResponseMock implements HttpServletResponse
{
    ...
    public ServletOutputStream getOutputStream() throws IOException
    {
        ...
        if( null == this.servOStream )
            oStream = new ServletOutputStreamMock();
        else
            oStream = new ServletOutputStreamMock( this.servOStream );
        // resets the status of servOStream to prevent us from possible using a closed strStream
     ...
     * calling getOutputStream from writing to a closed strStream
     *
