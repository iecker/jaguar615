...
public class HttpServletRequestMock implements HttpServletRequest
{
    ...
    public HttpServletRequestMock(ServletContext context)
    {
        scheme = "http";
     ...
     * and made available by the input strStream, or -1 if the
    ...
    {
        File contextDirectory = ((ServletContextMock) context).getContextDirectory();
     ...
     *
     * @see             RequestDispatcherMock
     * @see             ServletContextMock#getRequestDispatcher
     *
     */
    ...
    public HttpSession getSession(boolean b)
    {
        ...
        else if ((session != null) && (!((HttpSessionMock) session).isValid()) && (b))
            this.session = new HttpSessionMock(context);
