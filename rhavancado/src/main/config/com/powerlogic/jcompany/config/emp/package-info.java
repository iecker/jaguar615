...
@PlcConfigCompany(name = "Powerlogic SA", domain = "www.powerlogic.com.br", acronym = "PLC", 
			logo = "/recursos/midia/login-logo-empresa.png", address = "Av. Barão Homem de Melo, 4.554 / 2º andar. CEP:30.494-270, Estoril - Belo Horizonte/MG",
...
@PlcConfigPackage (entity=".entity.", application="com.powerlogic.rhavancado")
