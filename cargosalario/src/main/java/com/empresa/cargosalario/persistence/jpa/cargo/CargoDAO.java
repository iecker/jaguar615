package com.empresa.cargosalario.persistence.jpa.cargo;
...
@PlcAggregationDAOIoC(CargoEntity.class)
@SPlcDataAccessObject
@PlcQueryService
public class CargoDAO extends AppJpaDAO  {

	@PlcQuery("querySel")
	public native List<CargoEntity> findList(
