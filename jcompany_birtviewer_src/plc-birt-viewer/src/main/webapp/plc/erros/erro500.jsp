...
<html>
	<head>
		<title><fmt:message key="jcompany.error.500.titulo"/></title>
...
<body class="erros" marginheight="0" marginwidth="0" style="background-image: url(<%=request.getContextPath()%>/plc/erros/error_500.jpg)">
	<h1><fmt:message key="jcompany.error.500.titulo"/></h1>
	<h2><fmt:message key="jcompany.error.500.subtitulo"/></h2>
	<p><fmt:message key="jcompany.error.saudacao"/></p>
	<p><fmt:message key="jcompany.error.500.explicacao"/></p>
	<p><fmt:message key="jcompany.error.500.solucao1"/><fmt:message key="jcompany.error.500.solucao2"/></p>
