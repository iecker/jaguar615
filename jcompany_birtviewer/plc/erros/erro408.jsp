...
<html>
	<head>
		<title><fmt:message key="jcompany.error.408.titulo"/></title>
...
<body class="erros" marginheight="0" marginwidth="0" style="background-image: url(<%=request.getContextPath()%>/plc/erros/error_403.jpg)">
	<h1><fmt:message key="jcompany.error.408.titulo"/></h1>
	<h2><fmt:message key="jcompany.error.408.subtitulo"/></h2>
	<p><fmt:message key="jcompany.error.saudacao"/></p>
	<p><fmt:message key="jcompany.error.408.explicacao"/></p>
	<p><fmt:message key="jcompany.error.408.solucao"/></p>
